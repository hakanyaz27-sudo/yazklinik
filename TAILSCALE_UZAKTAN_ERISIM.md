...
Server her response'a `X-YK-Server: D300` header'i ekler ve uzak istekleri tespit edip
...
## YONTEM A — Tailscale Funnel (en kolay, en guvenli)
...
## YONTEM B — Router NAT + Caddy/Nginx (ozel port istiyorsaniz)
...
## YONTEM C — Tailscale Funnel + ozel port (en gelismis)
...
| Audit log rotate | [x] | D300_health_monitor zaten yapiyor |
