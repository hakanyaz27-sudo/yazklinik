...
## Ana modul (D:\YazKlinik_Final_D700\)

| Dosya | Boyut | Sorumluluk | Dokun? |
|---|---|---|---|
| `yazklinik_web.py` | ~13.6 MB | **Ana Flask uygulamasi** - tum route, UI, is mantigi | âœ… EVET (dikkatli) |
...
| Dosya | Ne |
|---|---|
| `AGENTS.md` | Codex / OpenAI agent ana brief (Turkce) + **Operasyonel Tuzaklar** |
| `CODEX_PROJECT.md` | Master reference (tek seferde tum proje) |
| `CODEX_HANDOFF_2026-05-26.md` | Son devir notu (Claude seansi: Alex+hiz+portal+mobil) |
| `README_D700.md` | Tam dokumantasyon |
...
| `D700_BASLAT.bat` | â˜… Tek tikla launcher |

## yazklinik_web.py Bolumleri (line araliklari)

> Bu dosya ~187k satir (2026-05-26). Asagidaki araliklar YAKLASIKtir ve ust bolumler kaymistir;
> kesin yer icin route/fonksiyon adini **grep** et. Editlerken yakin route'larin yanina ekle.
