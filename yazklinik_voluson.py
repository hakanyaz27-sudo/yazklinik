...
def parse_voluson_pdf(pdf_path):
    ...
    # --- 3) EFW (Hadlock) - "2240g Â± 327g  33w3d  86.6%" gibi satir ---
...
def _db_conn(db_path=None):
    ...
    # otherwise raw sqlite3 to the main DB. PRAGMA is a no-op (skipped) under PG.
    import yazklinik_db_adapter as _adapter
    con = _adapter.agent_connection("voluson", sqlite_path=db_path)
    try:
...
def match_patient(data, db_path=None):
    ...
    patients formatÄ±: folder_key = "F137230-26-03-09-1_Kilic_Seval",
...
def import_pdf(pdf_path, db_path=None, force=False):
    ...
    try:
        ...
        # === D700 2026-05-16: Hasta dosyasi kopru ===
        ...
        # === D700 2026-05-17: RAG auto re-index hook ===
