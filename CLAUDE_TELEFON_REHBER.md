# Telefondan Claude ile YazKlinik D250'u Kontrol - 3 Yol

## YOL 1: Claude.ai Project (en pratik) ★

### Kurulum (1 kez, 5 dakika)

1. Telefonda **Claude app** veya tarayicidan **claude.ai** ac
2. Sol ust **"Projects"** > **"New Project"**
3. Proje adi: **"YazKlinik D250"**
...
```
Bu proje: YazKlinik Pro Final D250 - Op. Dr. Hakan YAZ (Kadin Dogum) icin Flask/Python klinik yonetim sistemi.
...
Telefonda Claude > **"YazKlinik D250" project** ac > sor:
