# CODEX HANDOFF â€” Session 5 (2026-05-17) - 18 madde tek seans

**Branch:** `d700-safe-initial` (Claude fast-forward push)
...
```powershell
# Admin PowerShell:
cd D:\YazKlinik_Final_D500\akillilik\scripts
.\INSTALL_CRON_TASKS.ps1
```

### Mautic email automation
```powershell
cd D:\YazKlinik_Final_D500\akillilik\mautic
...
| Konsultasyon "klinik bilgi vakum" | GeÃ§mis vakalar + PubMed citation inject |
...
| USG Ã¶lcumu manuel rapor yazma | `/hasta/<key>/usg-rapor-taslak` canli Hadlock + tek tik kayit |
...
- **Mautic**: ilk acÄ±lÄ±ÅŸta DB init 2-5 dk
