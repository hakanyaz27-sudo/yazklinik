...
GA_MILESTONES = [
    {"week": (11, 14), "task": "NT ölçümü + üçlü test",
     "priority": "high", "patient_msg": "11-14 hafta arası ense kalınlığı ölçümü",
     "doctor_remind_days_before": 7},
    {"week": (18, 22), "task": "Detaylı ultrasonografi (morfolojik tarama)",
     "priority": "critical", "patient_msg": "Bebeğinizin organlarını detaylı inceleyeceğiz",
     "doctor_remind_days_before": 14},
    {"week": (24, 28), "task": "75g OGTT (GDM tarama)",
     "priority": "high", "patient_msg": "Şeker yükleme testi yapacağız",
     "doctor_remind_days_before": 7},
    {"week": (28, 28), "task": "RhD-neg ise anti-D",
     "priority": "high", "patient_msg": "Kan grubunuza göre koruyucu iğne",
     "doctor_remind_days_before": 3, "conditional": "rh_neg"},
    {"week": (28, 32), "task": "Demir + folik kontrolü",
     "priority": "medium", "patient_msg": "Vitamin takibi",
     "doctor_remind_days_before": 5},
    {"week": (35, 37), "task": "GBS sürveyansı (B grubu strep)",
     "priority": "high", "patient_msg": "Doğum öncesi son önemli tarama",
     "doctor_remind_days_before": 7},
    {"week": (37, 37), "task": "Doğum çantası hazırlama",
     "priority": "medium", "patient_msg": "Çantanız hazır mı? Doğum yaklaştı",
     "doctor_remind_days_before": 3},
    {"week": (40, 41), "task": "Term + post-term plan",
     "priority": "critical", "patient_msg": "Doğum günü yaklaştı, sık kontrol",
