#!/usr/bin/env python3
"""Sync YazKlinik D700 web settings to Windows/macOS terminal launchers."""
...
def main() -> int:
    ...
    server_url = (
        normalize_url(args.server_url)
        or normalize_url(cfg.get("YAZKLINIK_SERVER_URL", ""))
        or normalize_url(cfg.get("server_url", ""))
        or f"https://192.168.1.50:{port}"
    )
