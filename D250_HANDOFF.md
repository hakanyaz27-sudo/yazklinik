# YazKlinik Final D250 - Handoff

## Ne bu?

Bu klasor D200 son calisan surumunden uretilen D250 calisma kopyasidir.
...
```powershell
D:\YazKlinik_Final_D250\D250_BASLAT.bat
```

Manuel:

```powershell
Set-Location "D:\YazKlinik_Final_D250"
...
- D250 config yollari `D:\YazKlinik_Final_D250` klasorune ayarlandi.
- Lokal SQLite DB, calisan D200 DB uzerinden SQLite backup ile guvenli kopyalandi.
...
```powershell
Set-Location "D:\YazKlinik_Final_D250"
& "C:\Users\yazha\OneDrive\Desktop\YazKlinik_Final_D104\.venv\Scripts\python.exe" -m py_compile yazklinik_web.py yazklinik_v68.py yazklinik_feature_sync.py D250_TERMINAL_SYNC.py
