# YazKlinik D300 - RTX 5090 PC sifirdan kurulum scripti
...
Section "YazKlinik D300 - RTX 5090 Sifirdan Kurulum"
...
# === 1) Klasor + hedef yol ===
$installRoot = "D:\YazKlinik_Final_D300"
...
Write-Host "    3. D300_BASLAT.bat'i cift tikla"
Write-Host "    4. https://127.0.0.1:5443 (doktor / 1234)"
Write-Host ""
Write-Host "  Hata olursa:" -ForegroundColor Yellow
Write-Host "    D300_server.log + D300_whisper_service.log dosyalarini paylas"
Write-Host ""
Read-Host "Enter ile cik"
