...
# D700 v2: Gecici profile - Chrome kendi profilinde debug port acmiyor.
# Bu klasor BulutKlinik icin ozel, baska Chrome'lari etkilemez.
USER_DATA = r"D:\YazKlinik_Final_D500\bulutklinik_browser_profile"
DEBUG_PORT = 9222
    ...
    with sync_playwright() as p:
        ...
        if is_login:
            ...
            if "hakan" in r.text.lower() or "yaz" in r.text.lower():
                print(f"  âœ“ Profile ismi sayfada bulundu")
