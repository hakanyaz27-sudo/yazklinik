# YazKlinik D700 - Geri Cagirma Ajani WhatsApp Send Cron
...
#   schtasks /create /tn "YazKlinik WA Reminders" /tr "powershell.exe -ExecutionPolicy Bypass -File D:\YazKlinik_Final_D500\akillilik\scripts\whatsapp_send_reminders.ps1" /sc daily /st 09:00 /rl HIGHEST
