# YazKlinik D300 - Akillilik Paketi Kurulum Scripti
# Tarih: 2026-05-17
#
# Kullanim:
...
param(
    ...
    [string]$ProjectRoot = "D:\YazKlinik_Final_D300",
    [string]$VenvPython = "D:\YazKlinik_Final_D300\.venv\Scripts\python.exe"
)
...
Write-Host "    D:\YazKlinik_Final_D300\D300_BASLAT.bat"
