...
```powershell
# 1. Repo
cd D:\YazKlinik_Final_D500\akillilik\medsam
git clone https://github.com/bowang-lab/MedSAM.git .

# 2. Python paketler (ana .venv'e)
& D:\YazKlinik_Final_D500\.venv\Scripts\pip.exe install -e .
& D:\YazKlinik_Final_D500\.venv\Scripts\pip.exe install torch torchvision opencv-python segment-anything
...
& D:\YazKlinik_Final_D500\.venv\Scripts\python.exe scripts\app.py
