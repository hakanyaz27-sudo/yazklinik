...
**Tarih:** 2026-05-17
**Klasor:** `D:\YazKlinik_Final_D300\akillilik\`
...
- Server'i yeniden baslat: `Stop-Process python -Force; D300_BASLAT.bat`
- `/alex-rag-merkezi` -> "Re-Index" tikla (yeni embedding ile yeniden indeksle)
- Cache temizle: `D:\YazKlinik_Final_D300\rag_data\embed_cache\` icini sil
