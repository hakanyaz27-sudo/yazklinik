...
Write-Host " YazKlinik D300 FULL Installer (Session 7)   " -ForegroundColor Cyan
Write-Host "==============================================" -ForegroundColor Cyan
Write-Host ""
...
# Yeniden baslat (D300_BASLAT.bat var ise)
$startBat = "$projectRoot\D300_BASLAT.bat"
...
if ($smokeOk) {
    ...
    Write-Host "    D300_BASLAT.bat (cift tikla)"
