...
- Telefondan PC'deki D250 klasoruna komut gonderirsin
...
- D200 hasta verisine erisim YOK (cloud, lokal degil)
- Sadece ChatGPT-style sohbet ve genel kod sorulari
- D250 dosyalarini yuklemek icin file upload gerekir
...
| Senaryo | Onerilen |
|---|---|
| **D250 dosyalari + hasta verisi gerekli** | YOL 1 (Remote Control) ★ |
...
---
**D200** | **Claude Code Remote** | **2026-05-10**
